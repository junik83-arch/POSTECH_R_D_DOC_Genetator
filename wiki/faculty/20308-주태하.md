...
## 대표연구·최근 주도논문(제1/교신)
- Coherent Proton Transfer in the Excited State of Salophen Driven by a Specific Low-Frequency Skeletal Vibration (2026
- Journal of Physical Chemistry Letters)
- Understanding contrasting S2 → S1 internal conversion rates in boron-dipyrromethene derivatives via multi-configuration time-dependent hartree method (2025
- Physical Chemistry Chemical Physics)
- Ultrafast time-resolved fluorescence for probing vibrational wave packets in excited-state dynamics (2025
- Bulletin of the Korean Chemical Society)
- Single-dye calibration for accurate instrument response function in time-correlated single photon counting over the entire visible range (2025
- Review of Scientific Instruments)
- Tracking nuclear wave packets in excited-state reactions via quantum mechanics/molecular dynamics simulations (2025
...
- Tracking nuclear wave packets in excited-state reactions via quantum mechanics/molecular dynamics simulations (2025
- The Journal of Chemical Physics)
- Generation of 1 MHz 15 fs pulses in the near-infrared with high energy and their application to time-resolved spectroscopy (2024
- Optics Express)
...
## 공동참여논문(보조신호)
- Spider Webs as Passive Monitors of Microplastic and Its Copollutants in Indoor Environments (2025
- ACS Omega)
