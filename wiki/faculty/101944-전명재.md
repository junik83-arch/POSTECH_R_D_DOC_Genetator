...
>
> 전명재 교수는 현재 POSTECH의 부교수로 재직 중이며, 이전에는 UNIST 부교수 및 Microsoft Research에서 시스템 연구 그룹에 소속되어 있었습니다. 그의 주요 연구 분야는 효율적인 LLM 서빙 시스템, 지속 및 온디바이스 학습, 대규모 분산 학습, 그리고 빠르고 확장 가능한 빅데이터 분석입니다. 전 교수는 VLDB 2026에 "ORBITFLOW" 논문을 공동 저자로 게재했으며, EuroSys 2026에 "Carbon-Aware Continuous Learning" 및 "Garen" 논문을 공동 저자로 발표했습니다. 그는 ICDE 2022에서 최우수 논문상을 수상하는 등 다수의 수상 경력이 있습니다.
...
## 홈페이지 추가 정보
> 크롤링 시각: 2026-08-28T09:23:19+00:00 · 출처: <https://omnia.postech.ac.kr/>

_AI 요약은 이 페이지 맨 위에서 볼 수 있습니다 (Gemini 자동 요약 · 2026-08-28T10:07:31+00:00). 원문은 아래에서 확인 가능합니다._
...
#### OMNIA
> 출처: <https://omnia.postech.ac.kr/projects>
...
#### OMNIA
> 출처: <https://omnia.postech.ac.kr/contact>
...
Guidelines for contact (Graudate School Admission)
If you are interested in joining OMNIA, please send email to professor or lab representative with following instructions.
Add notation like '[OMNIA Admission]' into front of your email title. If not, we may miss your email.
Attaching your CV or transcript is recommended but it is not mandatory.
Email must be written in english or korean.
As we receive a lot of emails from diverse senders, we may miss your email. So if you don't receive reply within a week, you'd be better off sending email again.
Our location:
RIST Research Building IV Room 4304
77 Cheongam-ro, Nam-gu, Pohang, Gyeongsangbuk-do
Republic of Korea
Principal Investigator:
mj.jeon_at_postech.ac.kr
Lab Representative:
xinyuema_at_postech.ac.kr
Â©2020 OMNIA. Logo created by: suwhal_at_gmail.com.
Some pages
Home
Our research
