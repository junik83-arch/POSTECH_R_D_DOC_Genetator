...
>
> 김슬배 교수는 포항공과대학교 컴퓨터 보안 연구실(CompSec Lab)을 이끌고 있으며, 사이버-물리 시스템, 인공지능 시스템 등 다양한 컴퓨터 시스템의 보안 및 견고성 강화에 중점을 둔 연구를 수행합니다. 주요 연구 분야는 자동화된 취약점 발견 및 분석, 사이버-물리 시스템 보안 및 견고성, 사이드 채널 및 프로토콜 분석 등입니다. 김슬배 교수는 "RoboFuzz", "DriveFuzz", "SwarmBox" 등의 연구를 발표했으며, CSED415 컴퓨터 보안 및 CSED559 소프트웨어 취약점 분석 및 공격 과목을 가르치고 있습니다. 특히 CSED702C(현재 CSED559) 과목으로 2025년 학생 중심 교육 모델 경진대회에서 우수상을 수상했습니다.
...
## 홈페이지 추가 정보
> 크롤링 시각: 2026-08-28T09:20:31+00:00 · 출처: <https://compsec.postech.ac.kr>

_AI 요약은 이 페이지 맨 위에서 볼 수 있습니다 (Gemini 자동 요약 · 2026-08-28T10:03:58+00:00). 원문은 아래에서 확인 가능합니다._
